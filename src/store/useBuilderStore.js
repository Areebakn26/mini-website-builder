...
export const useBuilderStore = create((set) => ({
  apiKey: import.meta.env.VITE_AI_API_KEY || localStorage.getItem('ai_api_key') || '',
  baseUrl: import.meta.env.VITE_AI_BASE_URL || localStorage.getItem('ai_base_url') || 'https://api.groq.com/openai/v1',
  model: import.meta.env.VITE_AI_MODEL || localStorage.getItem('ai_model') || 'openai/gpt-oss-120b',
